const API = {
  ...
  register: (u, p, n, level, role, lang, topics) => API.request('POST', '/api/auth/register', { username: u, password: p, display_name: n, english_level: level, job_role: role, language: lang || 'en', topics: topics || [] }),
